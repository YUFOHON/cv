const styles = {
    ...
    sectionSubText:
      ...
      contactSubText: "sm:text-[18px] text-[14px] text-white uppercase tracking-wider",
      contactHeadText: "text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]",
  };
